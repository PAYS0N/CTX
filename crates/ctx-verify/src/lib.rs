//! ctx-verify: the token-frugal verification broker.
//!
...
//! change is bounded and deterministic. Layering mirrors the other
//! tools: [`cli`] (argv/io) over [`checks`] (pure orchestration) over
